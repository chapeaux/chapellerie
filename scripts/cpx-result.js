...
System.register("cpx-result", [], function (exports_1, context_1) {
  "use strict";
  var CPXResult;
    ...
    execute: function () { //import {PFElement} from '../../@pfelements/pfelement.umd.js';
      ...
      CPXResult = /** @class */ (() => {
        class CPXResult extends HTMLElement {
          constructor() {
            super();
            this._layout = '<div><a href="{{url}}">{{description}}</a><div>';
...
${
          ...
          set result(val) {
            ...
            this.created = this._result.created
          ...
          computeDescription(result) {
            ...
            if (result.highlight && result.highlight.sys_description) {
              ...
              result.highlight && result.highlight.sys_content_plaintext
            ) {
      ...
      exports_1("default", CPXResult);
      window.customElements.define("cpx-result", CPXResult);
    },
  };
});

const __exp = __instantiate("cpx-result");
